...
export default {
  ...
  methods: {
    setIsCircle(val) {
      val && this.opts.isProportional && (this.opts.isProportional = false)
      val && this.opts.aspectRatio && (this.opts.aspectRatio = 1)
      this.opts.isCircle = val
    },
    setAspectRatio(val) {
    ...
    drawOverlay() {
      ...
      ctx.fillRect(0, crY + crH, cnW, cnH - (crY + crH))
